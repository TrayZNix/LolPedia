...
MatchDataInterface matchDetailsFromJson(String str) =>
    MatchDataInterface.fromJson(json.decode(str));

String matchDetailsToJson(MatchDataInterface data) =>
    json.encode(data.toJson());

class MatchDataInterface {
  Data? data;
  ...
  factory MatchDataInterface.fromJson(Map<String, dynamic> json) =>
      MatchDataInterface(
