...
import 'package:lolpedia/UIs/lista_ligas/lista_ligas.dart';
import 'package:lolpedia/UIs/status_y_seleccion/status_y_seleccion.dart';
import 'package:lolpedia/dinamic_general_variables.dart';
import 'package:lolpedia/services/notifications_service.dart';
import 'package:lolpedia/widgets/app_bar_con_busqueda.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body:
            widget.currentIndex == 0
                ? Homepage(bloc: widget.bloc)
                : widget.currentIndex == 1
                ? ListaLigas(bloc: widget.bloc)
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          unselectedLabelStyle: GoogleFonts.anekDevanagari(
